...
const openItem1 = document.querySelectorAll('.checkitemInfoText')
const closeModal = document.querySelector('.closeModal')

const item0 = openItem1[0]
const item1 = openItem1[1]
const item2 = openItem1[2]
const item3 = openItem1[3]
const item4 = openItem1[4]
const item5 = openItem1[5]
const item6 = openItem1[6]
const item7 = openItem1[7]
const item8 = openItem1[8]
